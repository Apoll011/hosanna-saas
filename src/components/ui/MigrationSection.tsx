  ...
  return (
    <section className="py-12 md:py-16 bg-white overflow-hidden relative font-sans">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="bg-card rounded-3xl p-8 md:p-12 border border-border relative overflow-hidden shadow-soft reveal">
          <div className="relative z-10 grid lg:grid-cols-[1.05fr_0.95fr] gap-12 lg:gap-16 items-center">
            ...
            <div className="min-w-0">
              ...
              <h2 className="reveal text-3xl md:text-5xl font-display font-bold text-primary mb-6 tracking-tight">
            ...
            <div className="min-w-0 hidden lg:block reveal">
              <div className="relative mx-auto w-full max-w-sm select-none" aria-hidden="true">
                ...
                <svg
                  viewBox="0 0 320 72"
                  className="relative z-0 -my-1 h-[72px] w-full"
                  fill="none"
                >
                  <defs>
