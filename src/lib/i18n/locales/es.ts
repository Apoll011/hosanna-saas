export const es: typeof import("./pt").pt = {
  common: {
    ...
    activeDevDesc: "Como estamos en fase inicial, tus comentarios son nuestra brújula. Si echas en falta alguna función o encuentras algo que mejorar, compártelo con nosotros.",
  },
  errors: {
    notFoundTitle: "404",
    ...
    errorDesc: "Ocurrió un error por nuestra parte. Puedes intentar recargar la página o volver al inicio.",
  },
  seo: {
    defaultTitle: "Hosanna | El Futuro de la Planificación de Alabanza para Iglesias",
    defaultDescription: "Organiza tu biblioteca musical, planifica cultos y equipa a tus músicos con las herramientas adecuadas. Hosanna es el software de gestión de alabanza más intuitivo para iglesias modernas.",
    defaultKeywords: "planificación de alabanza, acordes, chordpro, gestión de iglesia, equipo de alabanza, repertorio cristiano, software para iglesias, ministerio de alabanza",
  },
  landing: {
    banner: "Estamos en fase de desarrollo inicial. La versión Beta se lanzará el 1 de septiembre. ¡Únete a este viaje!",
    nav: {
      features: "Funciones",
      chordpro: "ChordPro",
      pricing: "Precios",
    ...
    hero: {
      ...
      subtitle: "Dale a tu equipo la claridad y el enfoque que merecen. Planes de culto, acordes dinámicos y calendarios inteligentes en un solo lugar.",
      ctaStart: "Empezar Ahora",
      ctaDemo: "Ver Demostración",
      dashboardAlt: "Vista previa del panel de Hosanna mostrando la biblioteca de canciones y el plan del culto dominical",
      mobileAlt: "Vista previa de la app móvil de Hosanna mostrando una canción con controles de transposición",
    },
    problem: {
      eyebrow: "Nuestra Misión",
      title: "Preparar la alabanza debe ser adorar, no pelear con archivos.",
      description: "Sabemos que el tiempo del equipo de alabanza es oro. Muchas iglesias aún lidian con carpetas desordenadas en la nube, cancioneros antiguos y mensajes perdidos en chats. Hosanna nació para eliminar esa confusión y traer paz a tu preparación.",
      cards: [
        {
      ...
      quote: "«Nuestro objetivo es simple: queremos que tu equipo pase menos tiempo configurando tecnología y más tiempo sirviendo al Señor.»",
    },
    twoApps: {
      eyebrow: "Dos apps, un solo flujo",
      title: "Diseñado para todo el equipo de alabanza.",
      description: "Un panel potente para los líderes que planifican. Una app móvil limpia y enfocada para los músicos que tocan en vivo.",
    ...
    organize: {
      ...
      description: "Pon orden en años de canciones dispersas — sin obligar a tu equipo a aprender un sistema complicado.",
      cards: [
        {
    ...
    liveWorship: {
      ...
      description: "Guitarristas, pianistas y cantantes trabajan desde la misma canción en el mismo culto — pero cada uno elige su tono, visibilidad de acordes y tamaño de texto. Se acabaron los amontonamientos sobre una sola tablet. Se acabaron los acordes corridos.",
      items: {
    ...
    anySize: {
      ...
      description: "Cada iglesia tiene su biblioteca y cultos privados y seguros — con espacio para tantos equipos de alabanza como necesitéis.",
      privateLibTitle: "Tu biblioteca, segura y privada",
      privateLibBody: "Cada iglesia tiene su propio espacio. Canciones, cultos y miembros permanecen dentro de vuestras puertas.",
      multiTeamTitle: "Varios equipos, una sola biblioteca",
      multiTeamBody: "Domingo, entre semana, jóvenes, campus A, campus B — todos los equipos beben de la misma fuente.",
    },
    export: {
      eyebrow: "Exportación y portabilidad",
      title: "Tu música, bajo tus condiciones.",
      description: "Importa y exporta en formato abierto ChordPro para respaldos y migraciones fáciles. Exporta un culto entero — orden, lecturas bíblicas, anuncios, acordes y letras — como PDF listo para imprimir desde la app.",
      bullets: [
    ...
    pricing: {
      ...
      description: "Precios simples y transparentes para que te concentres en lo verdaderamente importante.",
      monthly: "Mensual",
      annual: "Anual",
      discountBadge: "-20%",
      singlePlan: "Plan Único",
      singlePlanDesc: "Acceso total a todas las funciones, sin límites de usuarios ni sorpresas ocultas.",
      ...
      pricingClarification: "Músicos y usuarios del panel ilimitados — la tarifa es por iglesia, sin importar el tamaño del equipo.",
      multiCampusLabel: "Iglesias multi-campus:",
      multiCampusText: "+12€/mes por cada sede adicional. Acceso ilimitado de usuarios en todas las sedes.",
      features: [
    ...
    mobileApp: {
      ...
      description: "Accede a tus acordes, consulta calendarios y prepárate para el culto directamente desde tu móvil. Hosanna App es la compañera ideal para músicos que buscan excelencia en cada detalle.",
    },
    vision: {
      ...
      quote2: "«Que sea de gran bendición para tu iglesia, tu equipo de alabanza y todos los que sirven con la música.»",
    },
    support: {
      eyebrow: "Apoya el proyecto",
      title: "Ayúdanos a llevar Hosanna a iglesias de todo el mundo",
      description: "Tu contribución nos permite seguir creando, mejorando y llevando esta herramienta a más ministerios de alabanza.",
      iframeTitle: "Apoya a Hosanna en GoFundMe",
    },
    roadmap: {
      eyebrow: "Roadmap",
      title: "Lo que viene a continuación.",
      description: "Hosanna sigue creciendo junto a las iglesias que confían en él. Estas son algunas de las mejoras que ya están en camino.",
      items: [
    ...
    finalCta: {
      ...
      subtitle: "Únete a cientos de iglesias que ya eligieron la excelencia y el orden con Hosanna.",
      ctaStart: "Empezar Ahora",
  ...
  migration: {
    ...
    songbookProDesc: "Un solo archivo de backup. Cifrados, tonos y tus sets se convierten en setlists.",
  ...
  contact: {
    ...
    heroSubtitle: "Dudas, sugerencias o simplemente un \"hola\". Estamos aquí para servir a tu iglesia con excelencia.",
    alwaysReadyTitle: "Siempre listos para ayudar",
    alwaysReadyDesc: "Nuestro equipo técnico y ministerial está disponible para garantizar que tu experiencia con Hosanna sea perfecta.",
    ...
    termsConsent: "Al enviar este formulario, aceptas el tratamiento de tus datos de acuerdo con nuestra",
  },
  chordproGuide: {
    heroBadge: "Guía de Formación · Equipo de Alabanza",
    heroTitleStart: "Domina",
    heroTitleHighlight: "ChordPro",
    heroSubtitle: "La forma estándar e inteligente de escribir acordes. Todo lo que tu equipo necesita saber para organizar su repertorio en Hosanna — desde el primer acorde hasta el día del culto.",
    ...
    whatIsLede: "Un formato de texto simple que Hosanna lee para transformar tus canciones en herramientas interactivas para la banda.",
    whatIsParagraph: "En lugar de colocar los acordes \"flotando\" sobre el texto, ChordPro los inserta dentro de la letra usando corchetes [ ] justo antes de la sílaba donde ocurre el cambio.",
    benefits: [
    ...
    anatomyLede: "La fórmula es siempre la misma: Información en la parte superior (Tono, Título), seguida de versos, coros y puentes.",
    oneDirectiveTwoWaysTitle: "Una directiva, dos formas de escribirla",
    oneDirectiveTwoWaysDesc: "Puedes usar la forma completa ({start_of_verse}) o la abreviatura ({sov}). ¡Hosanna entiende ambas por igual!",
    essentialDirectivesTitle: "Directivas Esenciales",
    essentialDirectivesLede: "Las instrucciones más utilizadas a diario. Incluyen funciones exclusivas de Hosanna para optimizar ensayos.",
    shortcutLabel: "atajo:",
    structureTitle: "Estructura de la Canción",
    structureLede: "Separa la letra en bloques para que Hosanna cree encabezados de colores automáticamente (Verso, Coro, Puente).",
    sections: {
    ...
    chorusMagicDesc: "Si usas {chorus} sin nada más, Hosanna copia y renderiza automáticamente la letra del último coro definido. ¡Ahorra tiempo y no reescribas!",
    ...
    gridsLede: "¿Necesitas escribir una intro o instrumental? Usa barras verticales para dibujar compases o define la duración de cada acorde.",
    ...
    durationsDesc: "Añade @X dentro del corchete del acorde para dictar su duración visual en la cuadrícula.",
    ...
    tabWarningDesc: "En el bloque de tablatura, Hosanna respeta al 100% los espacios introducidos y usa tipografía monoespaciada para mantener todo alineado.",
    shortcutsEyebrow: "Herramientas Prácticas",
    shortcutsTitle: "Atajos del Editor Hosanna",
    shortcutsLede: "No necesitas memorizar ni escribir directivas largas. Nuestro editor está pensado para ser ágil.",
    autocompleteTitle: "1. Autocompletar Acordes",
    autocompleteDesc: "A medida que añades acordes en la canción, Hosanna los memoriza. ¡Solo escribe [ y el editor te sugiere acordes!",
    selectAndWrapTitle: "2. Seleccionar y Envolver (Atajos y Clic Derecho)",
    selectAndWrapDesc: "¿Escribiste la letra sin secciones? Selecciona líneas con el ratón y usa atajos o el menú contextual.",
    ...
    typeAndTabDesc: "En una línea vacía del editor, escribe una de estas palabras clave y presiona Tab. ¡El editor completa el resto!",
    ...
    ctaDesc: "El editor inteligente de Hosanna te guía paso a paso para que las canciones queden impecables, organizadas y listas para el ensayo.",
